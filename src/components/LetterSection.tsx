                            ...
                            <div className="bg-[#fff8fb] rounded-2xl shadow-[0_20px_50px_rgba(232,120,154,0.25)] border border-[#f4a7be]/40 overflow-hidden">
                                ...
                                <div className="px-7 py-6 text-[#c2547a] space-y-4">
                                    ...
                                    <div className="text-xs leading-7 space-y-3 italic text-[#c2547a]/75">
                                        <p>สุขสันต์ครบรอบ 10 เดือนนะคะ
ขอบคุณที่เข้ามาเป็นความสบายใจ เป็นรอยยิ้ม และอยู่ข้างกันมาตลอด ถึงระหว่างทางเราจะมีทั้งวันที่เราหัวเราะ มีความสุข รวมถึงวันที่เรางอนกันหรือเข้าใจไม่ตรงกันบ้าง ขอบคุณที่ไม่เคยปล่อยมือและคอยทำให้รู้ว่าความรักของเรายังเติบโตขึ้นทุกวัน

10 เดือนอาจจะยังไม่นานมาก แต่สำหรับเรา มันเต็มไปด้วยความทรงจำดีๆมากมาย เค้าดีใจที่มีเบบี๋เป็นคนที่ได้แบ่งปันทั้งเรื่องเล็กๆในแต่ละวันและความฝันในอนาคต </p>
                                    </div>

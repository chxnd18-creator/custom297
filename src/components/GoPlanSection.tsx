...
const WISHES = [
  { id: 1,  text: "ไปดิสนีย์แลนด์ด้วยกันทั่วโลก",                color: "#ffd6e7" },
  { id: 2,  text: "เลี้ยงโกลเด้นครบ 10 ตัว", color: "#fce4ec" },
  { id: 3,  text: "มีแมวครบทุกสี",        color: "#fff0f8" },
  { id: 4,  text: "เที่ยวทั่วไทยครบทุกจังหวัด",           color: "#ffd6e7" },
  { id: 5,  text: "ไปดูบอลกับเบบี๋ที่อังกฤษ",          color: "#fce4ec" },
  { id: 6,  text: "กินหมาล่าครบทุกร้าน",  color: "#fff0f8" },
  { id: 7,  text: "พาเบบี๋ไปอควาเรียมทั่วโลก",          color: "#ffd6e7" },
  { id: 8,  text: "อยู่ด้วยกัน100ปี",         color: "#fce4ec" },
  { id: 9,  text: "สุขภาพแข็งแรงไปด้วยกัน",            color: "#fff0f8" },
  { id: 10, text: "รักกันไปนานๆ",            color: "#ffd6e7" },
];
